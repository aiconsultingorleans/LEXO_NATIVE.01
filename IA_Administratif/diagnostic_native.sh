...
echo "🌐 Ports Actifs:"
lsof -i :3000 -i :8000 -i :8004 -i :8005 -i :5432 -i :6379 2>/dev/null || echo "Aucun port actif"
echo ""
...
curl -s http://localhost:8005/health >/dev/null && echo "✅ DONUT OK" || echo "❌ DONUT KO"
...
[ -d "ai_services/venv_donut" ] && echo "✅ DONUT venv OK" || echo "❌ DONUT venv manquant"
echo ""
...
[ -f "logs/donut_native.pid" ] && echo "✅ DONUT PID: $(cat logs/donut_native.pid)" || echo "❌ DONUT PID manquant"
echo ""
...
cd ../ai_services && source venv_donut/bin/activate 2>/dev/null && python -c "import transformers, torch; print('✅ DONUT imports OK')" 2>/dev/null || echo "❌ DONUT imports KO"
cd ..
echo ""
